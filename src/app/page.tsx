        ...
        <section id="home" className="min-h-screen flex flex-col">
          ...
          <nav className="mb-4 flex flex-wrap gap-2 items-center justify-between py-2 z-50">
            <div className="flex flex-wrap gap-2">
              {["HOME", "ABOUT", "TECHSTACK", "CONTACTS"].map((item, index) => (
                <button
                  key={item}
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            <div className="bg-gray-800 p-4 rounded-lg border border-gray-600">
              ...
              <p className="text-gray-300">
                My journey began with a love for digital art and evolved into
                web development. Now, I focus on creating responsive, dynamic
                websites that reflect modern design principles and user-first
                thinking.
              </p>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg border border-gray-600">
              ...
              <ul className="list-disc ml-5 text-sm text-gray-400 space-y-1">
                <li>
                  🎓 Studying Bachelor of Science in Information Technology at
